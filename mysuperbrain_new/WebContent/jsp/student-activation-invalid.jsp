...
<meta charset="utf-8" />
<title>Student Activation | MySuperBrain</title>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Invalid Activation</li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Student Account Activation <small> <i
									class="ace-icon fa fa-angle-double-right"></i> Invalid Activation URL
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								<h2>Sorry! The user is already activated or invalid user activation URL or URL expired</h2>
