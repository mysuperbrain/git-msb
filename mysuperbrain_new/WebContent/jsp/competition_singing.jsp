					...
					<div class="page-content-area">
						...
						<div class="row">
							...
							<div class="col-md-8 col-md-offset-1">
								<form action="<%=request.getContextPath()%>/user/submit-singing-competition"
									method="post" id="singing-form" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<span class="fileUpload btn btn-default">
												    ...
												    <input type="file" class="upload" name="music_video" id="music_video" onchange="readURL(this)"/>
												</span>
									...
									<input type="hidden" name=client value="${client}" /> 
									 <input type="hidden" name=submission_type value="Music" /> 
...
<script
	...
	function readURL(input) {
		...
		var image=input;
		var image_obj = $('#music_video');
		if ((image.files[0].size / 1024).toFixed(0) >28*1024) {

			alert("Singing video must be less or equal to 25MB");
			...
			$('#singing-form').validate(
					{
						...
						messages : {
							...
							music_video : {
								required:"Please choose your singing.",
						...
						submitHandler : function(form) {
							...
							$('#singing-form button[type=submit]').prop("disabled", "disabled");		
							form.submit();
						}
