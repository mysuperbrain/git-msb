...
<meta charset="utf-8" />
<title>Singing Competition Submission Successful |
					...
					<div class="page-content-area">
						...
						<div class="row">
							...
							<c:if test="${param.success eq true }">
									...
									<a href="${pageContext.request.contextPath}/view/mysuperbrain/competition_music/${param.id}" class="btn btn-md btn-primary">View &amp; Share</a>
								</c:if>	
								<c:if test="${param.success eq false }">
								<c:if test="${param.exceeded eq true }">
