					...
					<div class="page-content-area">
						...
						<div class="row">
							...
							<div class="col-md-8 col-md-offset-1">
								<form action="<%=request.getContextPath()%>/user/submit-painting-competition"
									method="post" id="paint-form" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<span class="fileUpload btn btn-default">
												    <span><i class="ace-icon fa fa-paint-brush"></i>&nbsp;Select Your Painting</span>
												    <input type="file" class="upload" name="paint" id="paint" onchange="readURL(this)"/>
												</span>
...
<script
	...
	function readURL(input) {
		...
		if ((image.files[0].size / 1024).toFixed(0) > 2048) {
			...
			alert("painting must be less or equal to 2MB");
			...
			$('#paint-form').validate(
					{
						...
						messages : {
							description : {
								required:"Please provide summary for your painting.",
								minlength:"Please enter a valid length of description"
							},

							paint : {
								required:"Please choose your painting.",
						...
						submitHandler : function(form) {
							...
							$('#paint-form button[type=submit]').prop("disabled", "disabled");		
							form.submit();
						}
