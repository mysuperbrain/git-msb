...
<meta charset="utf-8" />
<title>${text_entry.competition.title} | ${text_entry.competitionCategory.category_name } | MySuperBrain.com</title>
<!-- <meta name="fb:app_id" content="820818497977425" />  -->
<meta name="og:url" content="<%=request.getContextPath() %>/view/${client}/competition_textentry/${text_entry.id}" /> 
<meta name="og:title" content="${text_entry.competitionCategory.category_name } Entry by ${text_entry.user_name} titled  ${text_entry.title} - MySuperBrain.com" /> 
<meta name="og:description" content="${text_entry.summary}" /> 
<meta name="og:image" content="<%=request.getContextPath()%>/img/logo.png" />
...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">${text_entry.competitionCategory.category_name } Entry </li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="alert alert-danger hide" id="liked-msg">
							...
							<span class="pull-left"><b>Submitted by :</b>&nbsp;${text_entry.user_name}</span>
							
							
						
							<span class="pull-right"><b>&nbsp;Votes :</b>&nbsp; <span id="votes"><c:set var="votes" value="${ (text_entry.points-20)/2 }"></c:set>
							<fmt:formatNumber maxFractionDigits="0" value="${votes}" type="number"/></span></span>
							
						<span class="pull-right"><b>Points :</b>&nbsp; <span id="points">${text_entry.points} </span>&nbsp; |</span>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								...
								<div class="post post-single">
									...
									<blockquote style="font-size: 14px;" >
											<p><b>Title :</b></p>
											 ${text_entry.competition.title}</blockquote>
										<div class="space-12"></div>				
										<blockquote style="font-size: 14px;">
											<p><b>Summary :</b></p>
											${text_entry.summary}</blockquote>
							...
							<div class="col-md-4">
							<c:if test="${text_entry.status eq 1 }">
								<div class="row alert alert-info" style="border-radius: 5px;">
								<form action="#" id="like-form">
								<input type="hidden" name="entry_username" value="${text_entry.user_name}">
								<input type="hidden" name="entry_id" value="${text_entry.id}">
								<input type="hidden" name="comp_type" value="txt">
								...
								<div class="widget-body">
									...
									<c:choose>
												<c:when test="${sessionScope.Student !=null }">
														...
														<input type="hidden" name="entry_id" value="${text_entry.id}">
														<input type="hidden" name="entry_type" value="TEXT">
								...
								<c:if test="${text_entry.status eq 0 }">
		...
		<span class="hide" id="copy-link">${pageContext.request.contextPath}/view/${client}/competition_textentry/${text_entry.id}</span>
	</div><!-- /.main-container -->
...
<![endif]-->
	...
	$('.fb-icon').click(function(){
		 ...
		 window.open('http://www.facebook.com/sharer.php?u=${pageContext.request.contextPath}/view/${client}/competition_textentry/${text_entry.id}','MySuperBrain Entry Share', 
				  'width=626,height=436');  
		return false;
	});
	$('.tw-icon').click(function(){
		window.open(
				  'https://twitter.com/share?url=${pageContext.request.contextPath}/view/${client}/competition_textentry/${text_entry.id}','MySuperBrain Entry Share',
				  'width=626,height=436'); 
					return false;
	...
	$('.gp-icon').click(function(){
		window.open(
				'https://plus.google.com/share?url=${pageContext.request.contextPath}/view/${client}/competition_textentry/${text_entry.id}','MySuperBrain Entry Share',
				  'width=626,height=436'); 
				return false;
