...
<meta charset="utf-8" />
<title>Login | MySuperBrain</title>
						...
						<div class="row">
							...
							<c:if test="${param.invalidsession eq true }">
								...
								<div id="loginbox" style="margin-top: 50px;"
									class="mainbox col-md-5 col-md-offset-3 col-sm-8 col-sm-offset-2">
									<div class="panel panel-info">
										...
										<div style="padding-top: 30px" class="panel-body">
											...
											<form:form method="POST" action="validateLogin" modelAttribute="user" autocomplete="off">
											<form:errors path="username" class="error-msg"></form:errors>
											<div style="margin-bottom: 25px" class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-user"></i></span>
													<form:input path="username" cssClass="form-control" id="username" title="Username"/>
													
											</div>
											<form:errors path="password" class="error-msg"></form:errors>
											<div style="margin-bottom: 25px" class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-lock"></i></span>
													<form:password path="password" cssClass="form-control" id="password" title="Password"/>
											...
											<div style="margin-top: 10px" class="form-group">
												...
												<div class="col-md-12 center"><br>
														<a href="<%=request.getContextPath() %>/forgot"
															...
															class="ace-icon fa fa-arrow-left"></i> &nbsp;Forgot Password? Click here to Recover
														</a>
												</div>
											</div>
										</form:form>
