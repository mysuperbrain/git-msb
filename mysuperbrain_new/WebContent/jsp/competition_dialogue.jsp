					...
					<div class="page-content-area">
						...
						<div class="row">
							...
							<div class="col-md-8 col-md-offset-1">
								<form action="<%=request.getContextPath()%>/user/submit-dialogue-competition"
									method="post" id="dialogue-form" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<span class="fileUpload btn btn-default">
												    ...
												    <input type="file" class="upload" name="dialogue_video" id="dialogue_video" onchange="readURL(this)"/>
												</span>
...
<script
	...
	function readURL(input) {
		...
		var image=input;
		var image_obj = $('#dialogue_video');
		if ((image.files[0].size / 1024).toFixed(0) >28*1024) {

			alert("Dialogue video must be less or equal to 25MB");
			...
			$('#dialogue-form').validate(
					{
						...
						messages : {
							entry_summary : {
								required:"Please provide summary for your dialogue.",
								minlength:"Please enter a valid length of description"
							},

							dialogue_video : {
								required:"Please choose your dialogue.",
								accept:"Please select a video/audio file"
							}
						},

						submitHandler : function(form) {
							
							$('#dialogue-form button[type=submit]').prop("disabled", "disabled");		
							form.submit();
						}
