				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Technical Problem <small> <i
									class="ace-icon fa fa-angle-double-right"></i> Error Occured
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								<h2>An unknow error occured while processing the request.</h2>
								<h3>We will resolve as early as possible. <a href="<%=request.getContextPath()%>/">Click here to continue</a></h3>
