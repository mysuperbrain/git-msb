...
<meta charset="utf-8" />
<title>${photography.competition.title} | ${photography.submission_type} | MySuperBrain.com</title>
<meta name="fb:app_id" content="820818497977425" /> 
<meta name="og:url" content="<%=request.getContextPath() %>/view/${client}/competition_photography/${photography.id}" /> 
<meta name="og:title" content="Painting Entry by ${photography.user_name} titled  ${photography.title} - MySuperBrain.com" /> 
<meta name="og:description" content="${photography.entry_summary}" /> 
<meta name="og:image" content="<c:url value='/${MsbConstants.PHOTOGRAPHY_URL}/${photography.submission_file_name}'/>" />
...
<body class="no-skin">
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">${photography.submission_type} Entry </li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="alert alert-danger hide" id="liked-msg">
							...
							<span class="pull-left"><b>Submitted by :</b>&nbsp;${photography.user_name}</span>
							
							
						
							<span class="pull-right"><b>&nbsp;Votes :</b>&nbsp; <span id="votes"><c:set var="votes" value="${ (photography.points-20)/2 }"></c:set>
							<fmt:formatNumber maxFractionDigits="0" value="${votes}" type="number"/></span></span>
							
						<span class="pull-right"><b>Points :</b>&nbsp; <span id="points">${photography.points} &nbsp; |</span></span>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								...
								<div class="post post-single">
									...
									<blockquote style="font-size: 14px;" >
											<p><b>Title :</b></p>
											 ${photography.competition.title}</blockquote>
										<div class="space-12"></div>				
										<blockquote style="font-size: 14px;">
											<p><b>Summary :</b></p>
											${photography.entry_summary}</blockquote>
										<div class="space-24"></div>			
											
												<div class="alert alert-info">	
													<div class="center thumbnail"><img alt="" class="img-responsive" style="display: initial;"
													src="<c:url value='/${MsbConstants.PHOTOGRAPHY_URL}/${photography.submission_file_name}'/>"
													></div>
												</div>
							...
							<div class="col-md-4">
							<c:if test="${photography.status eq 1 }">
								<div class="row alert alert-info" style="border-radius: 5px;">
								<form action="#" id="like-form">
								<input type="hidden" name="entry_username" value="${photography.user_name}">
								<input type="hidden" name="entry_id" value="${photography.id}">
								<input type="hidden" name="comp_type" value="photography">
								...
								<div class="widget-body">
									...
									<c:choose>
												<c:when test="${sessionScope.Student !=null }">
														...
														<input type="hidden" name="entry_id" value="${photography.id}">
														<input type="hidden" name="entry_type" value="PHOTOGRAPHY">
								...
								<c:if test="${photography.status eq 0 }">
	...
	<span class="hide" id="copy-link">${pageContext.request.contextPath}/view/${client}/competition_photography/${photography.id}</span>
	<!-- basic scripts -->
