...
<meta charset="utf-8" />
<title>${dialogue.competition.title}| ${dialogue.submission_type} |
	MySuperBrain.com</title>
<meta name="fb:app_id" content="820818497977425" />
<meta name="og:url"
	content="<%=request.getContextPath() %>/view/${client}/competition_photography/${dialogue.id}" />
<meta name="og:title"
	content="Painting Entry by ${dialogue.user_name} titled  ${dialogue.title} - MySuperBrain.com" />
<meta name="og:description" content="${dialogue.entry_summary}" />
<meta name="og:image"
...
<body class="no-skin">
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">${dialogue.submission_type}Entry</li>
					</ul>
					<!-- /.breadcrumb -->
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-md-12">
												...
												<div class="embed-responsive embed-responsive-16by9">
													<video width="400" controls class="embed-responsive-item">
														<source
															...
															src="<c:url value='/${MsbConstants.DIALOGUE_URL}/${dialogue.submission_file_name}'/>"
															type="video/mp4">
														<source
															src="<c:url value='/${MsbConstants.DIALOGUE_URL}/${dialogue.submission_file_name}'/>"
															type="video/ogg">
								...
								<div class="col-md-4">
							<c:if test="${dialogue.status eq 1 }">
								<div class="row alert alert-info" style="border-radius: 5px;">
								<form action="#" id="like-form">
								<input type="hidden" name="entry_username" value="${dialogue.user_name}">
								<input type="hidden" name="entry_id" value="${dialogue.id}">
								<input type="hidden" name="comp_type" value="Dialogue">
								...
								<div class="widget-body">
									...
									<c:choose>
												<c:when test="${sessionScope.Student !=null }">
														...
														<input type="hidden" name="entry_id" value="${dialogue.id}">
														<input type="hidden" name="entry_type" value="DIALOGUE">
								...
								<c:if test="${dialogue.status eq 0 }">
	...
	<!-- /.main-container -->
	<span class="hide" id="copy-link">${pageContext.request.contextPath}/view/${client}/competition_dialogue/${dialogue.id}</span>
	<!-- basic scripts -->
