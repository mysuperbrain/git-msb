					...
					<div class="page-content-area">
						...
						<div class="row">
							...
							<div class="col-md-8 col-md-offset-1">
								<form action="<%=request.getContextPath()%>/user/submit-photography-competition"
									method="post" id="photo-form" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<span class="fileUpload btn btn-default">
												    <span><i class="ace-icon fa fa-paint-brush"></i>&nbsp;Select Your Photography</span>
												    <input type="file" class="upload" name="photo" id="photo" onchange="readURL(this)"/>
												</span>
												
									</div>
									<a href="#" class="col-md-8 col-md-offset-1 thumbnail"> <img
													src="<%=request.getContextPath()%>/img/imgpreview.png"
													alt="..." id="imgpreview">
												</a>
...
<script
	...
	function readURL(input) {
		...
		if ((image.files[0].size / 1024).toFixed(0) > 2048) {
			...
			alert("photography must be less or equal to 2MB");
			...
			$('#photo-form').validate(
					{
						...
						messages : {
							entry_summary : {
								required:"Please provide summary for your photography.",
								minlength:"Please enter a valid length of description"
							},

							photo : {
								required:"Please choose your photography.",
								accept:"Please select a image file"
							}
						},

						submitHandler : function(form) {
							
							$('#photo-form button[type=submit]').prop("disabled", "disabled");		
							form.submit();
						}
