...
<meta charset="utf-8" />
<title>Student Activation | MySuperBrain.com</title>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Successful Activation</li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Student Account Activation <small> <i
									class="ace-icon fa fa-angle-double-right"></i> Successfully Activated
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								<h2>Thank you for activating your account at MySuperBrain</h2>
				<h3>Your account has activated now</h3>
				<a href="<%=request.getContextPath()%>/login">Click here to continue</a>
				<h4>Please contact us at contact@mysuperbrain.com or 97013 20902 with any questions.</h4>
							</div>
							<!-- /.col -->
						</div>
						<!-- /.row -->
