...
<meta charset="utf-8" />
<title> What Is Your talent | MySuperBrain.com</title>
<meta name="fb:app_id" content="820818497977425" /> 
<meta name="og:url" content="<%=request.getContextPath() %>/view/${client}/competition_textentry/${wiyt.id}" /> 
<meta name="og:title" content="What Is Your Talent Entry by ${wiyt.user_name} with description  ${wiyt.description} - MySuperBrain.com" /> 
<meta name="og:description" content="${wiyt.description}" /> 
...
<body class="no-skin">
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">What Is Your Talent Entry </li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="alert alert-danger hide" id="liked-msg">
							...
							<span class="pull-left"><b>Submitted by :</b>&nbsp;${wiyt.user_name}</span>
							
							
						
							<span class="pull-right"><b>&nbsp;Votes :</b>&nbsp; <span id="votes"><c:set var="votes" value="${ (wiyt.points-20)/2 }"></c:set>
							<fmt:formatNumber maxFractionDigits="0" value="${votes}" type="number"/></span></span>
							
						<span class="pull-right"><b>Points :</b>&nbsp; <span id="points">${wiyt.points} &nbsp; |</span></span>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								...
								<div class="post post-single">
									...
									<blockquote style="font-size: 14px;" >
											<p><b>Title :</b></p>
											 What Is Your Talent</blockquote>
										<div class="space-12"></div>				
										<blockquote style="font-size: 14px;">
											<p><b>Summary :</b></p>
											${wiyt.description}</blockquote>
										<div class="space-24"></div>			
											
												<div class="alert alert-info">	
													
													<c:if test="${wiyt.entry_type eq 'text'}">
													<div style="max-height: 550px; overflow-y: scroll;">
														${textEntryContent}
														</div>
														</c:if>
														<c:if test="${wiyt.entry_type eq 'image'}">
													<div class="center thumbnail"><img alt="" class="img-responsive" style="display: initial;"
													
													src="<c:url value='/${MsbConstants.WIYT_URL}/${wiyt.entry_file_name}'/>"
													></div>
														</c:if>
														<c:if test="${wiyt.entry_type eq 'video'}">
							...
							<div class="col-md-4">
							<c:if test="${wiyt.status eq 1 }">
								<div class="row alert alert-info" style="border-radius: 5px;">
								<form action="#" id="like-form">
								<input type="hidden" name="entry_username" value="${wiyt.user_name}">
								<input type="hidden" name="entry_id" value="${wiyt.id}">
								<input type="hidden" name="comp_type" value="WIYT">
								...
								<div class="widget-body">
									...
									<c:choose>
												<c:when test="${sessionScope.Student !=null }">
														...
														<input type="hidden" name="entry_id" value="${wiyt.id}">
														<input type="hidden" name="entry_type" value="WIYT">
	...
	<span class="hide" id="copy-link">${pageContext.request.contextPath}/view/${client}/competition_wiyt/${wiyt.id}</span>
	<!-- basic scripts -->
