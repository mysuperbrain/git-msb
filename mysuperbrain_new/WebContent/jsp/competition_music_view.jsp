...
<meta charset="utf-8" />
<title>${music.competition.title}| ${music.submission_type} |
	MySuperBrain.com</title>
<meta name="fb:app_id" content="820818497977425" />
<meta name="og:url"
	content="<%=request.getContextPath() %>/view/${client}/competition_photography/${music.id}" />
<meta name="og:title"
	content="Painting Entry by ${music.user_name} titled  ${music.title} - MySuperBrain.com" />
<meta name="og:description" content="${music.entry_summary}" />
<meta name="og:image"
...
<body class="no-skin">
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">${music.submission_type}Entry</li>
					</ul>
					<!-- /.breadcrumb -->
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-md-12">
												...
												<div class="embed-responsive embed-responsive-16by9">
													<video width="400" controls class="embed-responsive-item">
														<source
															...
															src="<c:url value='/${MsbConstants.MUSIC_URL}/${music.submission_file_name}'/>"
															type="video/mp4">
														<source
															src="<c:url value='/${MsbConstants.MUSIC_URL}/${music.submission_file_name}'/>"
															type="video/ogg">
								...
								<div class="col-md-4">
							<c:if test="${music.status eq 1 }">
								<div class="row alert alert-info" style="border-radius: 5px;">
								<form action="#" id="like-form">
								<input type="hidden" name="entry_username" value="${music.user_name}">
								<input type="hidden" name="entry_id" value="${music.id}">
								<input type="hidden" name="comp_type" value="Music">
								...
								<div class="widget-body">
									...
									<c:choose>
												<c:when test="${sessionScope.Student !=null }">
														...
														<input type="hidden" name="entry_id" value="${music.id}">
														<input type="hidden" name="entry_type" value="MUSIC">
	...
	<!-- /.main-container -->
	<span class="hide" id="copy-link">${pageContext.request.contextPath}/view/${client}/competition_music/${music.id}</span>
	<!-- basic scripts -->
