...
<meta charset="utf-8" />
<title>Forgot Password | MySuperBrain</title>
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Forgot Password <small> <i
									class="ace-icon fa fa-angle-double-right"></i> Please enter
									registered Username OR Email to recover your password
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
								...
								<div id="loginbox" style="margin-top: 50px;"
									...
									<div class="panel panel-info">
										...
										<div style="padding-top: 30px" class="panel-body">
											<form method="POST" id="frgtpwd-form">
											
											<div style="margin-bottom: 25px" class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-user"></i></span>
													<input type="text" name="username" class="form-control" id="username" placeholder="Username OR E-Mail"/>
											...
											<div style="margin-top: 10px" class="form-group">
												<!-- Button -->
												<div class="col-md-12 center controls">
													<button type="submit" id="frgtpwd-submit"
														class="btn btn-success" data-loading-text="Please Wait.....">Get Password</button>
												</div>									
...
<![endif]-->
	...
	jQuery(document).ready(function($) {
		...
		$("#frgtpwd-form").submit(function(event) {
	...
	function pwdViaAjax() {
		$.ajax({
			type : "POST",
			url : "${pageContext.request.contextPath}/getpwd",
			data : {"userNameOrMail":$("#username").val()},
			timeout : 100000,
			beforeSend:function(){
				$("#frgtpwd-submit").button('loading');
			},
			success : function(data) {
				...
				if(data=='emptyfield')
					bootbox.alert("Please enter registered username or mail");
				else
				if(data=='mailsent')
					bootbox.alert("Password sent to your registerd email.Thank You");
				else
					if(data=='passwordempty')
						bootbox.alert("Please make sure that you entered a registered username or email.");
					else
						if(data=='mailempty')
							bootbox.alert("You are not updated your mail in the profile.Please contact us at contact@mysuperbrain.com for further help.Thank you");
				$("#frgtpwd-submit").button('reset');
			},
			error : function(e) {
				console.log("ERROR: ", e);
				bootbox.alert(e);
