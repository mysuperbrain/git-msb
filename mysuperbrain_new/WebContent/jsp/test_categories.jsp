				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Page Header<small> <i
									class="ace-icon fa fa-angle-double-right"></i> Header Text
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
					...
					<ul class="nav nav-tabs padding-16">
						...
						<li id="kids-li"><a data-toggle="tab" href="#kids"> <i
								class="purple ace-icon fa fa-user bigger-125"> </i> Kids (1<sup>st</sup>
								to 3<sup>rd</sup> Grades)
						</a></li>
						<li id="junior-li"><a data-toggle="tab" href="#juniors">
								<i class="purple ace-icon fa fa-user bigger-125"> </i> Juniors
								(4<sup>th</sup> to 6<sup>th</sup> Grades)
						</a></li>

						<li id="senior-li"><a data-toggle="tab" href="#seniors">
